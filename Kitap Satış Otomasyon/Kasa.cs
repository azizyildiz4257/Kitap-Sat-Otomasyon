...
namespace Kitap_Satış_Otomasyon
{
    public partial class Kasa : Form
    {
        ...
        private void Kitaplistele()                        /*SatisNo*/
        {
            SqlDataAdapter da = new SqlDataAdapter("Select KitapAdı,AlısFiyatı,SatısFiyatı,KargoBedeli from Tbl_KitapSatis", bgl.baglan());
            da.Fill(ds);
